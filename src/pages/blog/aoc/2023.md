...
These are my worked solutions to Advent of Code 2023, which I used as an excuse
to learn Rust. Each day I take both parts of the puzzle and keep notes on the
approach as much as the answer.
...
```text caption="Example calibration document"
1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet
...
```rust caption="Day 1, Part 1 solution in Rust"
use regex::Regex;
...
```text caption="Example input with digits spelled out as words"
two1nine
eightwothree
abcone2threexyz
xtwone3four
...
```rust caption="Day 1, Part 2 solution in Rust"
use regex::Regex;
use std::{collections::HashMap, fs};
...
```text caption="Example game records"
...
```rust caption="Day 2, Part 1: sum the IDs of the possible games"
use std::{cmp::max, fs};
...
```text caption="The same example games, revisited for Part 2"
Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
...
```rust caption="Day 2, Part 2: sum the power of each minimum set"
use std::{cmp::max, fs};
